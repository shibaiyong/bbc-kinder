...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    beforeRouteLeave: function(to, from, next) {
      ...
      sessionStorageUtil.remove('temp-kinder-register-phone')
      sessionStorageUtil.remove('temp-kinder-register-code')
      next()
    },
    methods: {
      /** 
      ...
      _getSessionInfo: function() {
        this.passwordForm = {
          phone: sessionStorageUtil.get('temp-kinder-register-phone'),
          code: sessionStorageUtil.get('temp-kinder-register-code'),
          password: '',
          confirmPassword: ''
        }
      },
