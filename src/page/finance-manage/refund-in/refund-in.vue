          ...
          <div v-show="!addPageFlag">
            ...
            <div class="linkage">
              ...
              <div class="class-select">
                ...
                <el-select  class="input-com" v-model="statusDataList.statusId" placeholder="请选择">
                  <el-option
            ...
            <div class="table">
              <div class="table-title line-item">
                <div v-for="(item, index) in titleData" :class="item.class" class="item" style="width: 12.5%">{{item.value}}</div>
              </div>
              <div class="table-body">
                <div v-for="(data, index) in bodyData" class="line-item">
                  <div v-for="(item, j) in data" :class="item.class" class="item" style="width: 12.5%">
...
<style>
  /* 日期 */
  .refund-in .block .el-range-editor.el-range-editor.el-input__inner.input-com .el-range-separator{
    color: #99601C;
  }
  .refund-in .block .el-range-editor.el-input__inner{
    width: 680px;
    height: 32px;
    line-height: 32px;
    color: #fff;
  ...
  .refund-in .el-date-table td.today span{
    color: #269856;
  }
  .refund-in .el-date-table td.end-date span, .el-date-table td.start-date span{
    background: #269856;
  }
  .refund-in .el-date-table td.available:hover{
    color: #269856;
  }

  .refund-in .input-reset.ivu-btn-ghost:hover{
    background: rgba(248, 75, 98,.1)!important;
  }

  /* 弹框样式 */
  .refund-in .list-dialog .el-dialog{
    width: 880px;
    height: 600px;
    background: #FFFBEB;
    border-radius: 16px;
  ...
  .refund-in .el-dialog__header .el-dialog__title{
    color: #fff;
  }
  .refund-in .el-dialog__header .el-dialog__headerbtn .el-dialog__close{
    color: #fff;
    /* float: right; */
  }
  .refund-in .el-dialog__body{
    padding: 12px 30px;
  }
  .refund-in .el-dialog .el-dialog__body .table .line-item>div.item{
    width: 30%
  }

  .refund-in .class-select{
    display: inline-block;
    margin: 16px 0 0;
    margin-right: 12px;
  }
  .refund-in .class-select .select-txt{      
    border: none;
    color: #99601C;
    margin-right: 6px;
  }
  .refund-in .class-select .input-com {      
    width: 160px;
  }
  .refund-in .add-student-info span{
    display: inline-block;
    width: 8px;
    height: 18px;
    margin-right: 8px;
  ...
  .refund-in .add-student-info-btn{      
    margin-top: 160px;
    float: right;
  }   
</style>
