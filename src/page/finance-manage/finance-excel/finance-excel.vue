        ...
        <div class="left-control fill">
          ...
          <div class="item-tab clear-float">
            <div 
              ...
              :class="{'active-title': currentTabView === 'in'}" 
              @click.stop="_tabItemClick('in')">收费汇总表</div>
            <div 
              class="text-center clickable control-title"
              :class="{'active-title': currentTabView === 'out'}" 
              style="opacity: 0.7;cour">退费汇总表</div>
            <div 
              class="text-center clickable control-title"
              :class="{'active-title': currentTabView === 'inAndWillin'}" 
              style="opacity: 0.7">已缴未缴对比表</div>
          
          </div>
          <!-- 中间tab -->
          <div class="item-tab-content clear-float" v-if="currentTabView == 'in'">
            <div class="vice-tab float-left">今日</div>
            <div class="vice-tab float-left">本周</div>
            <div class="vice-tab float-left" style="color: #333;font-weight:700;">本月</div>
            <div class="vice-tab float-left">本年</div>
            <div class="vice-tab float-left">任意时间段</div>
          </div>

          <!-- <div> -->
          <table class="tabble-out">
            <tr class="tabble-line">
              <td class="tabble-cow">序号</td>
              <td class="tabble-cow">姓名</td>
              <td class="tabble-cow">11月保教费</td>
              <td class="tabble-cow">11月出勤</td>
              <td class="tabble-cow">11月伙食</td>
              <td class="tabble-cow">合计</td>
              <td class="tabble-cow">备注</td>
            </tr>
            <tr class="tabble-line">
              <td class="tabble-cow">1</td>
              <td class="tabble-cow">宁宁</td>
              <td class="tabble-cow">568</td>
              <td class="tabble-cow">22</td>
              <td class="tabble-cow">420</td>
              <td class="tabble-cow">988</td>
              <td class="tabble-cow"></td>
            </tr>
            <tr class="tabble-line">
              <td class="tabble-cow">2</td>
              <td class="tabble-cow">宇宇</td>
              <td class="tabble-cow">540</td>
              <td class="tabble-cow">20</td>
              <td class="tabble-cow">380</td>
              <td class="tabble-cow">920</td>
              <td class="tabble-cow"></td>
            </tr>
            <tr class="tabble-line">
              <td class="tabble-cow">3</td>
              <td class="tabble-cow">红阳</td>
              <td class="tabble-cow">560</td>
              <td class="tabble-cow">22</td>
              <td class="tabble-cow">420</td>
              <td class="tabble-cow">980</td>
              <td class="tabble-cow"></td>
            </tr>
            <tr class="tabble-line">
              <td class="tabble-cow">4</td>
              <td class="tabble-cow">小雨</td>
              <td class="tabble-cow">400</td>
              <td class="tabble-cow">14</td>
              <td class="tabble-cow">316</td>
              <td class="tabble-cow">716</td>
              <td class="tabble-cow"></td>
            </tr>
            <tr class="tabble-line">
              <td class="tabble-cow">5</td>
              <td class="tabble-cow">小白</td>
              <td class="tabble-cow">400</td>
              <td class="tabble-cow">12</td>
              <td class="tabble-cow">300</td>
              <td class="tabble-cow">700</td>
              <td class="tabble-cow"></td>
            </tr>
          </table>
          <!-- </div> -->
