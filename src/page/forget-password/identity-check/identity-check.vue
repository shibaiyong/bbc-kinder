    ...
    methods: {
      ...
      */
      ...
      _checkCode: function(param) {
        return requestCheckCode(param)
          .then( response => {
            let code = response.code
            switch (code) {
              case 200:
                sessionStorageUtil.set('temp-kinder-forget-phone', this.identityForm.phone)
                sessionStorageUtil.set('temp-kinder-forget-code', this.identityForm.code)
                this.identityText = ''
                this.errorFlag = false
